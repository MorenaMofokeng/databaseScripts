Rem NAME :	cretabs.sql
Rem
Rem FUNCTION
Rem   Create and populate tables and sequences to support the Summit 
Rem   Sporting Goods business scenario.  This file is modified from summit2.sql
Rem   which is used in several Oracle classes and demonstration files.
Rem   However, this file includes DROP TABLE commands.
Rem   NOTES
Rem 
Rem MODIFIED 
Rem     lbarnfie       15/MAR/95 - add DROP TABLE commands
...
(product_id                 NUMBER(7) 
 ...
 out_of_stock_explanation   VARCHAR2(140),
 restock_date               DATE,
...
INSERT INTO s_inventory VALUES (
   30433, 401, 0, 100, 175, 'A defective shipment was sent to Hong Kong and needed to be returned. The soonest ACME can turn this around is early February.', '07-SEP-92');
INSERT INTO s_inventory VALUES (
